...
<div class="col-md-6">
			...
			<div class="col-md-6">
				...
				<div class="input-group m-b" style="width:150px !important;">
					{!! Form::text('HireDate', $row['HireDate'],array('class'=>'form-control date')) !!}
					...
					<input type='checkbox' name='Status[]' value ='active'   class='' 
					@if(in_array('active',$Status))checked @endif 
					 /> Active </label> 
					 <label class='checked checkbox-inline'>   
					<input type='checkbox' name='Status[]' value ='inactive'   class='' 
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#Area").jCombo("{{ URL::to('employee/comboselect?filter=area:arename:arename') }}",
