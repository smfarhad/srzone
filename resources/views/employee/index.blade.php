...
<div class="sbox-tools" >
	...
	<div class="sbox-content"> 	
	    <div class="toolbar-line ">
			@if($access['is_add'] ==1)
	   		<a href="{{ URL::to('employee/update') }}" class="tips btn btn-lg btn-primary"  title="Add Employee">
			<i class="fa fa-plus-circle "></i>&nbsp;Add New Employee </a>
			@endif  
			...
			@endif 
			<a href="{{ URL::to( 'employee/search') }}" class="tips btn btn-lg btn-primary" onclick="SximoModal(this.href,'Advance Search'); return false;" ><i class="fa fa-search"></i> Search</a>				
			@if($access['is_excel'] ==1)
			<a href="{{ URL::to('employee/download?return='.$return) }}" class="tips btn btn-lg btn-primary" title="{{ Lang::get('core.btn_download') }}">
            ...
            @foreach ($rowData as $row)
                <tr>
				 ...
				 <td>
						...
						<a href="{{ URL::to('employee/show/'.$row->EmployeeId.'?return='.$return)}}" class="tips btn btn-xs btn-primary" title="{{ Lang::get('core.btn_view') }}"><i class="fa  fa-search "></i></a>
						@endif
						@if($access['is_edit'] ==1)
						<a  href="{{ URL::to('employee/update/'.$row->EmployeeId.'?return='.$return) }}" class="tips btn btn-xs btn-success" title="{{ Lang::get('core.btn_edit') }}"><i class="fa fa-edit "></i></a>
						@endif
