...
<link rel="shortcut icon" href="{{ asset('favicon.ico')}}" type="image/x-icon">	
		...
		<link href="{{ asset('sximo/js/plugins/markitup/sets/default/style.css') }}" rel="stylesheet">
		 <!-- invoice style -->
        <link href="{{ asset('/invoice/css/override.css')}}" rel="stylesheet">
        <link href="{{ asset('/invoice/css/app.css')}}" rel="stylesheet">	
		<!-- invoice style -->
	...
	<div id="wrapper">
		...
		<div class="footer fixed">
		    ...
		    <div>
		        <strong>{{ CNF_COMNAME }}  </strong> 
					Developed by Abdullah Al Mahamud | Phone: +880-1713210041
		    </div>
		</div>		
...
jQuery(document).ready(function ($) {
	...
	$('.spin-icon').click(function () {
        $(".theme-config-box").toggleClass("hidden");
    });
